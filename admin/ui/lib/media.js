...
export const KINDS = {
  ...
  "family-photo": { label: "scent family photo", cap: 10 * MB, types: PHOTO,
    rule: "JPEG, PNG or WebP, at least 900 px wide and 675 px tall, up to 10 MB",
    check: (d) => (d.width < 900 || d.height < 675 ? "A scent family photo needs to be at least 900 px wide and 675 px tall; this one is " + px(d.width, d.height) + "." : null) },
